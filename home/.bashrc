...
# enable color support of ls (sets LS_COLORS); ls/grep aliases now live in ~/.bash_aliases
...
# ls aliases (ll/la/l) now live in ~/.bash_aliases (shared with zsh)
...
edit_command_line() {
    local tmpf
    tmpf=$(mktemp /tmp/bash-edit.XXXXXX) || return
